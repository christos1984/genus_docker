...
class __TwigTemplate_79ccba9b214c09bff97e5cec568f99d956c910dd12fd7bf7623d655342ba8638 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        echo "
                ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "_username", [], "any", false, false, false, 16), 'row');
        echo "
                ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "_password", [], "any", false, false, false, 17), 'row');
        echo "
...
";
    ...
    {
        return array (  102 => 19,  97 => 17,  93 => 16,  89 => 15,  86 => 14,  80 => 11,  77 => 10,  75 => 9,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}
", "security/login.html.twig", "/var/www/symfony/app/Resources/views/security/login.html.twig");
    }
}
