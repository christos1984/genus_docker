...
class Genus extends \AppBundle\Entity\Genus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'subFamily', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'speciesCount', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'funFact', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'isPublished', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'firstDiscoveredAt', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'notes', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\Genus' . "\0" . 'genusScientists'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSubFamily(\AppBundle\Entity\SubFamily $subFamily)
    {
     ...
     * {@inheritDoc}
     */
    public function addGenusScientist(\AppBundle\Entity\GenusScientist $user)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGenusScientist', [$user]);

        return parent::addGenusScientist($user);
    }

    /**
     * {@inheritDoc}
     */
    public function removeGenusScientist(\AppBundle\Entity\GenusScientist $genusScientist)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGenusScientist', [$genusScientist]);

        return parent::removeGenusScientist($genusScientist);
    }
    ...
    public function getGenusScientists()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGenusScientists', []);

        return parent::getGenusScientists();
    }
